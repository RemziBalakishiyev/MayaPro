...
/**
 * FE#103 (TC-32.4) — bağlanış tarixçəsi sorğusu şəbəkə xətası ilə uğursuz
 * olduqda "Bağlanış yoxdur" boş-siyahı mesajı ƏVƏZİNƏ `InlineError` +
 * "Yenidən" düyməsi göstərilməlidir (maliyyə-həssas ekran).
 */
...
describe("ClosingHistory — şəbəkə xətası (FE#103)", () => {
  beforeEach(() => {
